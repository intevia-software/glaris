...
const Bar = () => {
    return (
        <div className="w-full px-0 lg:px-0 xl:px-5 2xl:px-36 mt-24 pt-5 bg-gray-100">
            <div className="w-full block lg:flex pb-5 px-5 items-center">
                ...
                <div className="w-full lg:w-2/3 block my-0 lg:my-0 ">
